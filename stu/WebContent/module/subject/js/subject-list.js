...
$(function() {
	...
	$("#search").click(function() {
		...
		dataTableParam.key = dataTableParam.key + "," + content;

		console.debug(dataTableParam);
...
function member_edit(data) {
	member_add("修改用户", "SubjectController/addOrEditSubject.do?id=" + data, "", 510);
}
...
function datasDelete() {
	...
	$.ajax({
		"type" : 'post',
		"url" : Global.contextPath + '/SubjectController/deleteSubject.do',
		"dataType" : "json",
		"data" : {
			"ids" : ids
		},
			...
			.dataTable(
					{
						...
						"aoColumns" : [// 表格数据填充
								{
									...
									"mDataProp" : "sub_weight",
									"sClass" : "text-c",
								}, {
									"mDataProp" : "sub_pre",
									"sClass" : "text-c",
								}, {
									"mDataProp" : "sub_remark",
									"sClass" : "text-c",
								}],
						...
						"fnServerData" : function(sSource, aoData, fnCallback) {
							$.dataTableService(
									'SubjectService$getAllSubjectByPage',
