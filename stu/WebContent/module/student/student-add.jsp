...
<script type="text/javascript"
	src="${contextPath }/module/student/js/student-add.js"></script>
</head>
<body>
	<div class="pd-20">
			...
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" class="input-text" placeholder="" id="id"
						name="id" datatype="*1-16" value="${student.id }" onkeyup="onlyNum(this)"
			...
			<div class="row cl">
				...
				<div class="formControls col-5 skin-minimal">
					<input type="text" class="input-text" name="name" id="name"
						value="${student.name }" nullmsg="姓名不能为空" onkeyup="value=value.replace(/[^\u4E00-\u9FA5]/g,'')"/>
				</div>
				<div class="col-4"></div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" class="input-text" value="${student.born }"
						placeholder="" id="born" name="born" nullmsg="籍贯不能为空" onkeyup="value=value.replace(/[^\u4E00-\u9FA5]/g,'')">
				</div>
				<div class="col-4"></div>
			</div>
			<div class="row cl">
